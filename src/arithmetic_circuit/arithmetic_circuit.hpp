...
/*
 * A arithmetic_circuit gate is composed of a type (ex. SUM, PRODUCT) and a vector of
...
/*************************** ARITHMETIC CIRCUIT ******************************/
    ...
    public:
        ...
        /*
         * Returns the evaluation of the arithmetic_circuit for the given input. Note that
         * the size of input_t must match the arithmetic_circuit's input size. If the arithmetic_circuit
         * contains no gates, the evaluation will return 0.
         */
        FieldT evaluate(const input_t<FieldT> &input) const;

        /*
         * Adds the provided gate to the arithmetic_circuit. Each gate is composed of
        ...
        /* Clears all sum and product gates from the arithmetic_circuit */
        void clear_gates();
        ...
        /* Returns the number of inputs for the arithmetic_circuit */
        size_t num_inputs() const;

        /* Prints arithmetic_circuit size, arithmetic_circuit degree, and number of inputs */
        void print_info() const;

        /*
         * Adds a quadratic arithmetic_circuit of degree 3, by dividing the input length
         * into two components, left and right, each of length middle = input / 2.
         * The arithmetic_circuit takes an inner product of the left component with the
         * right component.
        */
         ...
         * Adds a quadratic arithmetic_circuit of degree 3, by dividing the input length
         * into two components, left and right, each of length middle = input / 2.
         * The arithmetic_circuit takes an inner product of the left component with itself
         * length middle times. This constructs a new length middle component,
         * call it square. The arithmetic_circuit then takes an inner product of the
